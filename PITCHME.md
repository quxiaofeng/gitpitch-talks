...
- 如何为这个博客添砖加瓦，增加功能与内容。（根据自身能力和需求，选择使用）|
...
- 博客或者说个人网站的主要作用 |
   ...
   - 知识与经验的积累整理与补充（外脑）|
   - 分享、讨论、观点碰撞、避免回声 |
- 知识经济主要平台已经出现垄断：知乎（专栏）、微信公众号 |
- 静态网站的功能与局限：没有动态的 CGI， 没有数据库，便于分发托管 |
...
- 示例：数学、学术向 [Optimization](http://www.quxiaofeng.me/optimization) 
- 示例：程序算法向 [zhuyingtai.ml](http://www.zhuyingtai.ml)
- 示例：简洁大方 [Doorknob](http://www.quxiaofeng.me/doorknob)
- 示例：另类学术 [Web 版论文](http://www.quxiaofeng.me/lps/lps) vs [原版论文](http://www.quxiaofeng.me/docs/tsmc-linear-palmprint.pdf)
...
- 聚焦内容 Markdown + 表现力 HTML 5 + CSS 3 + JavaScript |
...
- GitHub repo 上：CNAME 文件 www.lumitalk.tk |
- 十分钟后测试 lumitalk.tk|
...
- 内容细节需要调整的也可以参考 [Jekyll 格式参考](https://jekyllrb.com/docs/posts/)
- Markdown 做演示 [示例](https://gitpitch.com/quxiaofeng/hexo-site-3p0/gitpitch) [源码](https://github.com/quxiaofeng/hexo-site-3p0/blob/gitpitch/PITCHME.md)
- 其它的例子
  - [收藏夹](http://quxiaofeng.me/links) [source](https://raw.githubusercontent.com/quxiaofeng/hexo-site-3p0/master/source/links.md)
  - [剑桥计算机系 - 论文列表](http://www.cl.cam.ac.uk/~dc552/) [[网页模板](https://github.com/davidchisnall/camtemplate)]
  - 代码库
...
- http://jekyllthemes.io 新的、收费免费都有
- http://themeforest.net 最新的设计作品、收费
...
- 数学公式 [MathJax](https://www.mathjax.org/) [KaTex](https://khan.github.io/KaTeX/) [1](https://github.com/quxiaofeng/optimization/blob/master/_includes/head.html#L21) [2](https://github.com/quxiaofeng/optimization/blob/master/_includes/footer.html#L16)
- 绘制序列图 [websequencediagrams.com](http://websequencediagrams.com) [JavaScript 实现](https://bramp.github.io/js-sequence-diagrams/index.html#usage) （程序员三大浪漫）
- 绘制流程图 [flowchart.js](https://flowchart.js.org/)
- 评论与留言 [Disqus](https://disqus.com/) （需要科学上网）
- [网页设计基础](https://waxdoll.gitbooks.io/webdesignfoundations/content/)
...
- 打印 [Resume Cards Example](http://ellekasai.github.io/resumecards/) Responsive [@media print](https://github.com/ellekasai/resumecards/blob/gh-pages/stylesheets/resumecards.scss#L495)
- 修改模板: layout include
- 加入额外的数据 \_data 并进行处理
- 加入更多的 js 功能
